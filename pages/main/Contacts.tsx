...
import { CheckCircle, Clock, Mail, Phone, Send, ShieldAlert } from 'lucide-react';
          ...
          >
            <div className="text-center space-y-3">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 max-w-xl mx-auto">
                Have questions regarding plans, indicators, simulator parameters
                or Telegram access? We are here to support.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                ...
                {contactSubmitted ? (
                  <div className="text-center py-12 space-y-4">
                    ...
                    <p className="text-xs text-slate-500 leading-relaxed max-w-xs mx-auto">
                      Thank you for contacting SMARTFLOWALGO support. An
                      educational representative will respond within our support
                      hours.
                    </p>
                    <button
              ...
              <div className="md:col-span-5 space-y-6 text-xs">
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 rounded-xl text-[11px] text-slate-500 flex items-start gap-2 leading-relaxed">
                  ...
                  <span>
                    <strong>Please Note:</strong> Our desk coordinates
                    educational programs, plans, and indicators. We are strictly
                    prohibited from giving individual stock tips, trading
                    guidance, or handling real capital trading accounts.
                  </span>
                </div>
              </div>
            </div>
